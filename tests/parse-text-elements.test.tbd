...
const lineElementsData = [
  ...
  ['blah #tag blah', [{ type: 'text', value: 'blah ' }, {type: 'tag', name: 'tag', text: '#tag', value: '[true]' },{type:'text', value: ' blah'}]],
  ['blah # tag blah', [{ type: 'text', value: 'blah # tag blah' }]],
  ['blah #', [{ type: 'text', value: 'blah #' }]],
  ['blah #tag(   )', [{ type: 'text', value: 'blah ' }, {type: 'tag', name: 'tag', text: '#tag(   )', value: '[true]' }]],
  ['blah #tag( params', [{ type: 'text', value: 'blah ' }, {type: 'tag', name: 'tag', text: '#tag', value: '[true]'},{type:'text', value: '( params'}]],
  ['blah #tag(1,2)', [{ type: 'text', value: 'blah ' }, {type: 'tag', name: 'tag', text: '#tag(1,2)', value: '[1,2]'}]],
  ['blah #tag(["a"])', [{ type: 'text', value: 'blah ' }, {type: 'tag', name: 'tag', text: '#tag(["a"])', value: '[["a"]]'}]],
